						...
						<form action="<?php base_url('admin/pelanggans/edit') ?>" method="post" enctype="multipart/form-data" >
							...
							<div class="form-group">
								...
								<input class="form-control <?php echo form_error('nama_store') ? 'is-invalid':'' ?>"
								 type="text" name="nama_store" placeholder="Nama Store" value="<?php echo $editPelanggan->nama_store;?>" />
							...
							<div class="form-group">
								...
								<input class="form-control <?php echo form_error('alamat_store') ? 'is-invalid':'' ?>"
								 type="text" name="alamat_store" placeholder="Email Store" value="<?php echo $editPelanggan->alamat_store;?>"/>
								<div class="invalid-feedback">
							...
							<div class="form-group">
								...
								<input class="form-control <?php echo form_error('email_store') ? 'is-invalid':'' ?>"
								 type="email" name="email_store" value="<?php echo $editPelanggan->email_store;?>"/>
								<div class="invalid-feedback">
							...
							<div class="form-group">
								...
								<input class="form-control <?php echo form_error('telepon_store') ? 'is-invalid':'' ?>"
								 type="number" name="telepon_store" placeholder="Telepon Store" value="<?php echo $editPelanggan->telepon_store;?>"/>
								<div class="invalid-feedback">
...
<!-- /.container-fluid --><?php $this->load->view("admin/_partials/bawah.php") ?>